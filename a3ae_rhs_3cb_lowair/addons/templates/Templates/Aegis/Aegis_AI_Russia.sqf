...
private _vehiclesMilitiaLightArmed = ["O_R_LSV_02_armed_F"];
...
private _vehiclesMilitiaCars = ["O_R_LSV_02_unarmed_F"];
...
_traitorLoadoutData set ["uniforms", ["U_O_R_CombatUniform_tshirt_taiga_F"]];
